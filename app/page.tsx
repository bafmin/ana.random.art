    ...
    <div className="space-y-20">
      <section className="grid items-start gap-10 pt-6 lg:grid-cols-2 lg:gap-12">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            <a href="#work" className="rounded-full bg-zinc-950 px-4 py-2 text-sm font-semibold text-white hover:bg-zinc-800 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-200">
              View work
            </a>
      ...
      <section id="about" className="scroll-mt-28 space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-zinc-600 dark:text-zinc-300">
            {site.artist} is a digital artist focused on character creation.
          </p>
        </div>

        <div className="grid gap-4 lg:grid-cols-3">
          <div className="rounded-2xl border border-zinc-200/70 bg-zinc-50 p-4 dark:border-zinc-800/70 dark:bg-zinc-900/20 lg:col-span-2">
            <div className="text-sm font-semibold">Style</div>
            <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-zinc-700 dark:text-zinc-300">
              <li>Readable silhouettes and strong shapes</li>
              <li>Expressive faces and clean color choices</li>
              <li>Sheets built for production and story</li>
            </ul>
          </div>
          <div className="rounded-2xl border border-zinc-200/70 bg-zinc-50 p-4 dark:border-zinc-800/70 dark:bg-zinc-900/20">
            ...
            <div className="mt-4 text-xs text-zinc-500">Update this list in lib/gallery.json.</div>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <Link href={`mailto:${site.email}?subject=Commission%20Request`} className="rounded-full bg-zinc-950 px-4 py-2 text-sm font-semibold text-white hover:bg-zinc-800 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-200">
